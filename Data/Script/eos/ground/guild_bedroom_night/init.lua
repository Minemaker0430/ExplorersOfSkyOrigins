...
function guild_bedroom_night.CH2_NightAfterJob()
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['CH2_S3_PARTNER_4_'..tostring(pTalkKind)], CH('Wigglytuff'):GetDisplayName()))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['CH2_S3_PARTNER_5']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['CH2_S3_PARTNER_6_'..tostring(pTalkKind)], CH('Spoink'):GetDisplayName()))
	GAME:WaitFrames(45)
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['CH2_S3_PARTNER_9_'..tostring(pTalkKind)], CH('PLAYER'):GetDisplayName()))
