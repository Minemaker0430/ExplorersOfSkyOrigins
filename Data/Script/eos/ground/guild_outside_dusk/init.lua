...
function guild_outside_dusk.CH1_PartnerWimpsOut()
	...
	local coro1 = TASK:BranchCoroutine(function() GROUND:CharWaitAnim(koffing, "Nod")
										GAME:WaitFrames(45)
										GROUND:MoveInDirection(koffing, Direction.Down, 180, false, 1)
									end)
	local coro2 = TASK:BranchCoroutine(function() GROUND:CharWaitAnim(zubat, "Nod")
										GAME:WaitFrames(45)
										GAME:WaitFrames(10)
										GROUND:MoveInDirection(zubat, Direction.Down, 180, false, 1)	
									end)
	...
	local coro4 = TASK:BranchCoroutine(function()
										GAME:WaitFrames(300)
										SOUND:FadeOutSE("Ambient/AMB_Fire_Loud", 120)
									end)
