...
function guild_guildmaster_chambers.CH2_FormingTeam()
    ...
    GROUND:MoveToPosition(CH('PARTNER'), CH('PARTNER').Position.X + 0, CH('PARTNER').Position.Y + -12, false, 1)
    GAME:WaitFrames(10)
    GROUND:MoveToPosition(CH('PLAYER'), CH('PLAYER').Position.X + 0, CH('PLAYER').Position.Y + -12, false, 1)
    -- !! WaitExecuteLives(ACTOR_ATTENDANT1)
