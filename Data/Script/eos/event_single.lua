...
function SINGLE_CHAR_SCRIPT.DrenchedBluffTutorial(owner, ownerChar, context, args)
    ...
    elseif args.Floor == 4 then
			if SV.drenched_bluff.Tutorial < 4 then
				...
				UI:WaitShowDialogue(STRINGS:Format(RogueEssence.StringKey("TUTORIAL_16"):ToLocal(), STRINGS:LocalKeyString(4), STRINGS:LocalKeyString(21), STRINGS:LocalKeyString(22), STRINGS:LocalKeyString(23), STRINGS:LocalKeyString(24)))
